...
public class DBHelper {
    ...
    public Connection getCon(){
        ...
        try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/travellingguideline?useSSL=false&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF8","root","527527");
        } catch (SQLException e) { }
        return connection;
    }
